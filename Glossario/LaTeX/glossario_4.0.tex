\documentclass[a4paper,11pt]{article}
	...
	\section*{Registro delle modifiche}
		\begin{longtable}{{|p{0.10\textwidth}|p{0.15\textwidth}|p{0.15\textwidth}|p{0.50\textwidth}|}} 
			...
			\rigaregistro{4.0}{L.Alessio \newline (Responsabile)}{10/08/2016}{Approvazione del documento.}
			\rigaregistro{3.1}{M.Crivellaro \newline (Verificatore)}{26/07/2016}{Verifica del documento.}
			\rigaregistro{3.0.1}{D.Bortot \newline (Progettista)}{20/07/2016}{Aggiunto il termine 'XML'.}	
			\rigaregistro{3.0}{L.Alessio \newline (Responsabile)}{29/06/2016}{Approvazione del documento.}
			\rigaregistro{2.1}{M.Crivellaro \newline (Verificatore)}{26/06/2016}{Verifica del documento.}			
			\rigaregistro{2.0.3}{L.Alessio \newline (Analista)}{22/06/2016}{Aggiunti i termini "Back-End", "Front-End", "Materializecss" e "Material Design".}			
...
\sezioneglos{B}
	\beginglos
		\itemglos{Back-End}{Back-End è un termine largamente utilizzato per caratterizzare le interfacce che hanno come destinatario un programma. Una applicazione Back-End è un programma con il quale l'utente interagisce indirettamente, in generale attraverso l'utilizzo di una applicazione Front-End. In una struttura client/server il Back-End è il server.
Viene spesso utilizzato in contrapposizione con Front End.}
...
\sezioneglos{F}
	\beginglos
		...
		\itemglos{Front-End}{Front-End è un termine largamente utilizzato per caratterizzare le interfacce che hanno come destinatario un utente. Una applicazione Front-End è un programma con il quale l'utente interagisce direttamente. In una struttura client/server il Front-End è il client.
Viene spesso utilizzato in contrapposizione con Back-End.}
	\fineglos
\newpage
\sezioneglos{G}
	\beginglos
...
\sezioneglos{M}
	\beginglos
		...
		\itemglos{Material Design}{Linguaggio di design con cui Google ha deciso di rinnovare tutti i suoi prodotti e sotto il quale gestirli tutti quanti allo stesso modo, con gli stessi principi di esteriorità grafica.}
		\itemglos{Materializecss}{Moderno framework front-end responsive basato su Material Design}
...
\sezioneglos{X}
	\beginglos
		\itemglos{XML}{sigla di eXtensible Markup Language è un metalinguaggio per la definizione di linguaggi di markup, ovvero un linguaggio marcatore basato su un meccanismo sintattico che consente di definire e controllare il significato degli elementi contenuti in un documento o in un testo.}
	\fineglos
