...
\pagenumbering{Roman}
	...
	\vspace{50mm}
	\textbf{Analisi dei Requisiti 1.0.2}
	%\'end{center}
	%\'begin{center}
	%\vspace{4mm}
	\end{center}
...
\midrule
F 4.2.2 & Se la domanda richiede una risposta inserita dal'utente allora viene fornito un campo per l'inserimento della risposta\\
\midrule
...
\midrule
F 6.1.2.1 & Se il codice QML inserito non risulta valido viene visualizzato un messaggio di errore\\
\midrule
F 6.1.3 & La sezione dedicata alla creazione di un questionario deve permettere l'inserimento del codice QML che lo definisce\\
\midrule
...
\midrule
F 8.1.4 & Una domanda deve appartenere ad una o più categorie\\
\midrule
F 8.1.5 & Una domanda deve avere una tipologia definita da QML\\
\midrule
F 8.1.5.1 & QML definisce domande di tipo vero o falso\\
\midrule
F 8.1.5.2 & QML definisce domande a scelta multipla\\
\midrule
F 8.1.5.3 & QML definisce domande a risposta testuale\\
\midrule
F 8.2 & QML definisce questionari\\
\midrule
F 8.2.1 & Un questionario è formato da una lista di domande\\
\midrule
F 8.3 & QML gestisce immagini all'interno di domande e risposte preimpostate\\
...
\midrule
V 2 & Domande e questionari vengono gestiti con il linguaggio QML\\
\midrule
V 3 & La parte server viene realizzata in javascript con server Node.js\\
