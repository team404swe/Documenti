	...
	\section*{Registro delle modifiche}
		...
		\beginregistro
			\rigaregistro{\textbf{Versione}}{\textbf{Autore}}{\textbf{Data}}{\hspace{5 mm} \textbf{Descrizione}}
					\rigaregistro{0.2.1}{Martin Mbouenda (Responsabile)}{13/05/2016}{Approvazione documento.}	
	 		\rigaregistro{1.0.6}{Andrea Multineddu (Verificatore)}{13/05/2016}{Verifica e revisione documento.}
...
\midrule
F 4.2.3 & Se la domanda richiede una risposta inserita dal'utente allora viene fornito un campo per l'inserimento della risposta & Obbligatorio\\
\midrule
...
\midrule
F 6.1.4 & La sezione dedicata alla creazione di un questionario deve permettere l'inserimento del tempo di compilazione & Facoltativo\\
\midrule
