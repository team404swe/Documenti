...
\pagenumbering{Roman}
	...
	\section*{Sommario}
	Questo documento illustra il Piano di Progetto del gruppo Team 404 relativo al capitolato \textbf{Quizzipedia}, commissionato da \textbf{Zucchetti S.p.A.}
	\\
	Lo scopo del documento è definire e presentare al committente l'Organigramma del gruppo, la pianificazione e gestione delle risorse, le scelte progettuali significative adottate (quali il modello di ciclo di vita scelto per lo sviluppo e la politica di gestione dei rischi adottata), le problematiche d'interesse incontrate durante l'avanzamento e l'Offerta Tecnico-Economica relativa al progetto.	
