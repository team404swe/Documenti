...
\begin{document}
	...
	\section*{Registro delle modifiche}
		\begin{longtable}{{|p{0.10\textwidth}|p{0.15\textwidth}|p{0.15\textwidth}|p{0.50\textwidth}|}} 
			...
			\rigaregistro{1.0.6}{D. Bortot \newline(Responsabile)}{02/04/2016}{Aggiunte considerazioni finali in §8.1.2.4}
			\rigaregistro{1.0.5}{D. Bortot \newline(Responsabile)}{01/04/2016}{Inserita corretta nomenclatura del verbale in §8.1.1. Aggiornata versione dei documenti di riferimento in §2.2 e §2.3}
