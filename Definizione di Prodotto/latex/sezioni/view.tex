...
\item\textbf{Attributi}:
	\begin{itemize}
		\item\code{controller}: reference to page controller\\
	\end{itemize}
\item\textbf{Metodi}:
	\begin{itemize}
...
\item\textbf{Metodi}:
	\begin{itemize}
		...
		\item\code{sort(by)}: ordina la lista delle domande secondo il criterio \code{by}\\
			...
			\textbf{Parametri}:
				...
				\end{itemize}
		\item\code{search(query)}: visualizza la lista delle domande che soddisfano il criterio di ricerca \code{query}\\
...
\item\textbf{Metodi}:
	\begin{itemize}
		...
		\item\code{sort(by)}: ordina la lista dei questionari secondo il criterio \code{by}\\
			\textbf{Precondizioni}: l'utente ha selezionato un criterio di ordinamento\\
			...
			\textbf{Parametri}:
				\begin{itemize}
					\item\code{by}: criterio di ordinamento\\
				\end{itemize}
		\item\code{search(query)}: visualizza la lista dei questionari che soddisfano il criterio di ricerca \code{query}\\
			\textbf{Precondizioni}: l'utente ha selezionato un criterio di ricerca\\
		...
		\item\code{sort(by)}: ordina la lista delle categorie secondo il criterio \code{by}\\
			...
			\textbf{Parametri}:
				\begin{itemize}
					\item\code{by}: criterio di ordinamento\\
				\end{itemize}
		\item\code{search(query)}: visualizza la lista delle categorie che soddisfano il criterio di ricerca \code{query}\\
			\textbf{Precondizioni}: l'utente ha selezionato un criterio di ricerca\\
