\documentclass[a4paper,11pt]{article}
	...
	\end{center}
	\introtab{Specifica Tecnica 3.0}			%1 nome documento
			{3.0} 							%2 versione
			{Esterno} 						%3 Uso
	...
	\textbf{Descrizione}}
	\rigaregistro{3.0}{Alex Beccaro (Responsabile)}{15/08/2016}{Approvazione del documento.}
	\rigaregistro{2.1}{Luca Alessio (Verificatore)}{14/08/2016}{Verifica delle sezioni riadattate.}
	\rigaregistro{2.05}{Davide Bortot (Progettista)}{10/08/2016}{Riadattate classi del package ViewModel (§8.2.1, §8.2.2, §8.2.4).}
	\rigaregistro{2.0.4}{Davide Bortot (Progettista)}{05/08/2016}{Riadattate classi del package View (§8.1, §8.1.1, §8.1.2).}
	\rigaregistro{2.0.3}{Davide Bortot (Progettista)}{23/07/2016}{Rimosso il pattern Singleton (§8.2.4.3 - §11).}
	\rigaregistro{2.0.2}{Andrea Multineddu (Programmatore)}{15/07/2016}{Modifica diagrammi di attività (fig. 9 - 10)}
	\rigaregistro{2.0.1}{Luca Alessio (Verificatore)}{13/07/2016}{Apportamento correzioni rilevate durante la RQ: ampliamento spiegazione svantaggi AngularJS, revisione di alcune scelte architetturali e correzione di altri errori minori.}
	\rigaregistro{2.0}{Luca Alessio (Responsabile)}{25/06/2016}{Approvazione del documento.}
	\rigaregistro{1.1.1}{Davide Bortot (Progettista)}{23/06/2016}{Correzione errori rilevati in seguito a verifica.}
	\rigaregistro{1.1}{Marco Crivellaro (Progettista)}{22/06/2016}{Verifica del documento.}
	\rigaregistro{1.0.19}{Davide Bortot (Progettista)}{21/06/2016}{Aggiunta sezione "Linguaggio QML" (§5).}
	\rigaregistro{1.0.18}{Davide Bortot (Progettista)}{21/06/2016}{Caricati i diagrammi di sequenza aggiornati alla nuova architettura (§10).}
	...
	\rigaregistro{1.0.16}{Davide Bortot (Progettista)}{19/06/2016}{Aggiunta la classe Router al ViewModel (aggiunte in §6.2.2 e §8.2.5) e il rispettivo tracciamento in §21.1.}
	...
	\rigaregistro{1.0.13}{Davide Bortot (Progettista)}{11/06/2016}{Eliminati ed inglobati nel package "Controllers" i packages "QuizManager" e "QuestionManager", ed eliminati i relativi design pattern in §11. Riadattato il package Interpreter (§8.2.4). Aggiunto il design pattern Publish-Subscribe (§11.3).}
	\rigaregistro{1.0.12}{Andrea Multineddu (Progettista)}{09/06/2016}{Definizione delle subpackage del Model "Database"(§7.1.1) e "Publishers" (§7.1.4).}
	\rigaregistro{1.0.11}{Andrea Multineddu (Progettista)}{08/06/2016}{Ridefinizione del package Model (§6.1).}
	\rigaregistro{1.0.10}{Davide Bortot (Progettista)}{05/06/2016}{Definizione delle classi del ViewModel "Controllers" (§8.2.1), "Subscribers" (§82.2) e "Methods" (§8.2.3).}
	\rigaregistro{1.0.9}{Davide Bortot (Progettista)}{04/06/2016}{Prima definizione delle classi del ViewModel, con conseguente aggiornamento di §6.2.2 e §8.2.}
