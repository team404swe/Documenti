...
<<<<<<< HEAD
	...
	\rigaregistro{0.0.7}{Davide Bortot (Progettista)}{29/04/2016}{Stesura della sezione §4.3 "Package Presenter" e delle sue sottosezioni.}
=======
...
Una volta ottenuti i dati si preoccupa di aggiornare la View. Nel sistema Quizzipedia implementa la parte logica, affiancata a quella grafica, del Client. Realizza un totale disaccoppiamento tra Model e View, controllandone i flussi di comunicazione.
	...
	\begin{itemize}
		...
		\item E' responsabile del calcolo ed aggiornamento delle statistiche relative a domande, questionari e utenti.
	\end{itemize}
