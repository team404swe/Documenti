\documentclass[a4paper,11pt]{article}
	...
	\textbf{Descrizione}}
	\rigaregistro{0.0.14}{Davide Bortot (Progettista)}{07/05/2016}{Inseriti grafici dei Diagrammi di Sequenza.}
...
%	\end{center}
	...
	\textbf{Postcondizioni:} L'utente ha scelto un questionario da svolgere e viene reindirizzato alla pagina contenente tale questionario.\\ %è giusta solo questa post o c'è altro?
	\textbf{Descrizione:} SCRIVERE APPENA ARRIVA IMMAGINE DEFINITIVA\\
	\newpage
