\documentclass[a4paper,11pt]{article}
	...
	\rigaregistro{0.0.13}{Davide Bortot (Progettista)}{06/05/2016}{Completata la sezione "Diagrammi delle classi del Presenter" con l'aggiunta dei grafici UML.}
...
\item\textbf{Attività svolte e dati trattati:} questa classe prevede le funzionalità basilari per l'autenticazione dell'utente all'interno del sistema come registrazione, login e  logout ed altre operazioni secondarie come il cambio o il recupero della password smarrita.
			...
			\begin{itemize}
				...
				\item\textbf{Concretizzazioni}: Attualmente l'interfaccia Input viene concretizzata nelle seguenti sottoclassi:
				\begin{itemize}
				...
				\item\textit{ViewQuizTutorial}
				\item\textit{ViewQuizList}
				\item\textit{OrderQuizList}
				\end{itemize}
			\end{itemize}
...
\newpage
	...
	\subsection{Creazione di una Domanda}
%	\begin{center}
...
%	\end{center}
	...
	\newpage
	\subsection{Navigazione in un Questionario}
%	\begin{center}
%		\includegraphics[scale=0.1]{"../images/qualcosa".png}
%	\end{center}
	\textbf{Precondizioni:} \\
