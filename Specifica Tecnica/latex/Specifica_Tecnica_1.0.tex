...
DA INSERIRE FIGURA PACKAGE VIEW\\
	...
	\section{Diagrammi delle classi}
			...
			CONTENUTO DA VERIFICARE NON SON SICURO RISPETTI LE ULTIME DECISIONI PRESE
			\\ANCHE NUMERAZIONe DA RIVEDERE PERCHE' NON ESISTONO LE SUBSUBSUBSECTION
...
relazione di dipendenza (?) verso i rispettivi packages Sender, Receiver ed UserAuthentication
			...
			\subsection{UserAuthentication}
				BOZZA\\
				DEVO FINIRE DI SPIEGARE CHE C'E' ANCHE UN UTENTE ADMIN E COSA CAMBIA\\
			UserAuthentication:

User: regola la registrazione, l'accesso e l'uscita di un utente
	- login(mail,password)
	- register(newMail,newPassword)
	- logout()
	- changePassword()
	- forgotPassword()
