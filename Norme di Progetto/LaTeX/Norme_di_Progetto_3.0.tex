%!TEX encoding = UTF-8 Unicode	
	...
	%\begin{longtable}{{p{0.10\textwidth}p{0.15\textwidth}p{0.12\textwidth}p{0.50\textwidth}}}
		...
		%REVIZIONE DI QUALIFICA
			\rigaregistro{3.0}{L. Alessio (Analista)}{05/06/2016}{Approvazione del documento alla versione 3.0}
			\rigaregistro{2.0.5}{M.Mbouenda  (Responsabile)}{04/06/2016}{Correzione errori rilevati in seguito a verifica}
			\rigaregistro{2.0.4}{A. Multineddu  (Progettista)}{02/06/2016}{Revisione del documento}
			\rigaregistro{2.0.3}{M.Mbouenda  (Responsabile)}{28/05/2016}{Ristrutturazione secondo ISO 12207: processo di gestione, processo di allestimento. inizio miglioramento attività di progettazione}
