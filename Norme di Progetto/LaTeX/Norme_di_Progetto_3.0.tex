%!TEX encoding = UTF-8 Unicode	
	...
	%\begin{longtable}{{p{0.10\textwidth}p{0.15\textwidth}p{0.12\textwidth}p{0.50\textwidth}}}
		...
		%REVIZIONE DI QUALIFICA
			\rigaregistro{3.0}{M. Crivellaro (Amministratore)}{05/06/2016}{Approvazione del documento alla versione 3.0}
			\rigaregistro{2.2}{M.Mbouenda  (Responsabile)}{04/06/2016}{Verifica del documento}
