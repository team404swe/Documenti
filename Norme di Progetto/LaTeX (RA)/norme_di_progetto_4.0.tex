%!TEX encoding = UTF-8 Unicode	
	...
	\section{Introduzione}
		...
		\subsection{Glossario}
			Viene allegato un glossario nel file "\textit{glossario\_4.0.pdf}" nel quale viene data una definizione a tutti i termini che in questo documento appaiono con il simbolo \textbf{'\addglos'}  a pedice.
		\subsection{Riferimenti}
			\subsubsection{Normativi}
				\begin{itemize}
					\item \textbf{Capitolato d'appalto Quizzipedia:}\\
					\url{http://www.math.unipd.it/~tullio/IS-1/2015/Progetto/C5.pdf}
					\item \textbf{Analisi dei Requisiti:} "\textit{analisi\_dei\_requisiti\_4.0.pdf}"
					\item \textbf{Piano di Progetto:} "\textit{piano\_di\_progetto\_4.0.pdf}"
					\item \textbf{Piano di Qualifica:} "\textit{piano\_di\_qualifica\_4.0.pdf}"
...
\end{itemize}
\subsubsubsection{Standard utilizzati}
