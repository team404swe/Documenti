...
\begin{document}
	...
	\introtab{Piano di qualifica}			%1 nome documento
			...
			{Luca Alessio - Alex Beccaro} 	%7 Verifica
	...
	\rigaregistro{4.0}{L.Alessio (Responsabile)}{23/8/2016}{Approvazione documento}
	\rigaregistro{3.5}{A.Beccaro (Verificatore)}{20/8/2016}{Verifica finale}
	\rigaregistro{3.4}{M.Crivellaro (Verificatore)}{14/8/2016}{Aggiunto "non implementato" per i test di funzionalità non implementate}
	\rigaregistro{3.3}{M.Crivellaro (Verificatore)}{10/8/2016}{Aggiunta sezione codifica ultimo paragrafo resoconto misurazioni}
	\rigaregistro{3.2}{M.Crivellaro (Verificatore)}{15/8/2016}{Modifiche sulle sezioni test di unità}
	\rigaregistro{3.1}{Marco Crivellaro (Verificatore)}{1/8/2016}{Spostati contenuti capitolo 2 in norme di progetto}
	\rigaregistro{3.0}{A. Beccaro (Responsabile)}{3/7/2016}{Approvazione documento}
	\rigaregistro{2.4.1}{L.Alessio (Verificatore)}{3/7/2016}{Verifica finale}
	\rigaregistro{2.4}{M. Crivellaro (Verificatore)}
	{2/7/2016}{aggiunta sezione esito misurazioni per la fase progettazione dettaglio}
	\rigaregistro{2.3.7}{M.Crivellaro (Verificatore)}
	{2/7/2016}{aggiunte tabelle tracciamento metodi - test di unità, test di unità - metodi}
	\rigaregistro{2.3.6}{M.Crivellaro (Verificatore)}
	{1/7/2016}{aggiunte tabelle tracciamento componenti - requisiti e requisiti componenti}
	\rigaregistro{2.3.5}{M.Crivellaro (Verificatore)}
	{27/6/2016}{sezione test di unità completata}
	\rigaregistro{2.3.4}{M.Crivellaro (Verificatore)}
	{25/6/2016}{bozza test di unità}
	\rigaregistro{2.3.3}{M.Crivellaro (Verificatore)}
	{19/6/2016}{conclusa sezione test di integrazione}
	\rigaregistro{2.3.2}{M. Crivellaro (Verificatore)}
	{18/6/2016}{conclusa sezione test di integrazione}
	\rigaregistro{2.3.1}{M. Crivellaro (Verificatore)}
	{17/6/2016}{Aggiunta sezione test di integrazione prima bozza}
	\rigaregistro{2.3}{M. Crivellaro (Verificatore)}
	{15/6/2016}{Inizio redazione paragrafo specifica test}
	\rigaregistro{2.2}{M. Crivellaro (Verificatore)}{11/6/2016}{Spostati contenuti di gestione amministrativa revisione e procedure controllo qualità processi e prodotto nella prima nuova sezioneStrategia generale di qualifica}
	\rigaregistro{2.1}{M. Crivellaro (Verificatore)}{10/6/2016}{Riarrangiamento sezioni ora divise per processi secondo standard ISO}
	\rigaregistro{2.0}{M. V.  Mbouenda(Responsabile)}{14/05/2016}{Approvazione documento}
	\rigaregistro{1.6.2}{M.Crivellaro (Analista/Ver.)}{13/05/2016}{Verifica finale}
	\rigaregistro{1.6.1}{A. Beccaro (Verificatore)}{12/05/2016}{Miglioramento impaginazione tabelle e completamento sezione test}
	\rigaregistro{1.6}{A. Beccaro (Verificatore)}{05/05/2016}{Aggiunta sezione test di sistema e requisiti di qualità}
...
%verifica della disponibilità delle risorse umane e tecnologiche e dell'ambiente di lavoro.
...
%\item \textbf{Corretta pianificazione di sviluppo} secondo quanto stilato sempre nel documento \textit{Piano-di-Progetto-2.0.pdf}. In particolare viene verificata la corretta divisione temporale delle diverse fasi di progetto e la correttezza del preventivo in base al budget disponibile;
%\item verifica della \textbf{disponibilità delle risorse umane e tecnologiche} e dell'ambiente di lavoro;
...
\subsubsubsection{Budget variance} Indica se alla data corrente si è speso di più o di meno rispetto a quanto previsto a budget alla data corrente.\\
Formula: 
\begin{center}
\textbf{BV = BCWS – ACWP}
\end{center}
...
\end{itemize}
\subsubsection{Metriche e misure}
\subsubsubsection{Copertura dei requisiti}
...
\end{itemize}
\subsubsection{Metriche e misure}
\subsubsubsection{Parameter count}
...
\begin{itemize}
	...
	\end{itemize}
%\subsubsubsection{XXXNumber of methods}
...
\subsubsection{Metriche e misure}
\subsubsubsection{Cyclomatic complexity}
...
\begin{itemize}
	...
	\end{itemize}
\subsubsubsection{Metriche di Halstead} Queste metriche sono state concepite per identificare proprietà misurabili del codice e le relazioni tra di esse. Questi numeri sono staticamente calcolati dal codice sorgente.\\
Dati: 
\begin{itemize}
...
\begin{itemize}
	...
	\end{itemize}
\end{itemize} 
%\subsubsubsection{Dependency count}
%Conteggio del numero di chiamate di tipo \textbf{require}\addglos di ogni metodo. Valori bassi sono da preferire.
\subsubsubsection{Maintainability Index} Rappresenta l'indice principale dei risultati dell'analisi effettuata sull'intero codice. Compreso tra 0 e 100, questo indice rappresenta la relativa facilità di manutenzione del codice analizzato. Valori alti rappresentano miglior manutenibilità.\\
...
%%Processo che ha la funzione di integrare le varie componenti del sistema controllandone la corretta interazione. 
%
%%\subsubsection{Obiettivi}
%%Per rendere l'attività di verifica della corretta integrazione delle diverse parti, si utilizza il framework di testing \textit{Jasmine}. Tale strumento rende più facile e gestibile l'attività di creazione ed esecuzione dei test di integrazione.

%%\subsubsection{Metriche e misure}
%%\subsubsubsection{Componenti integrate}
%%Indica la percentuale di componenti implementate che interagiscono correttamente all'interno del sistema, rispetto al totale delle componenti progettate.
%%\begin{itemize}
%%\item Range ottimale: [100\%]
%%\item Range di accettazione: [100\%]
%%\end{itemize}
...
\subsubsection{Metriche e misure}
\subsubsubsection{Test di Accettazione eseguiti}
...
Parametri utilizzati: 
\begin{itemize}
	\item Range-accettazione: \begin{math}[90\%]\end{math}
\item Range-ottimale: \begin{math}[100\%]\end{math}
	\end{itemize}
\subsubsubsection{Test di Sistema eseguiti}
...
\item Range-ottimale: \begin{math}[100\%]\end{math}
	\end{itemize}
\subsubsubsection{Test di Integrazione eseguiti}
...
\subsubsubsection{Test di Unità eseguiti}
...
Parametri utilizzati: 
\begin{itemize}
	\item Range-accettazione: \begin{math}[80\%]\end{math}
\item Range-ottimale: \begin{math}[100\%]\end{math}
	\end{itemize}
...
Copertura dei test di accettazione & \begin{math}[90\%]\end{math}& \begin{math}[100\%]\end{math}\\ \hline
Copertura dei test di sistema & \begin{math}[90\%]\end{math}& \begin{math}[100\%]\end{math}\\ \hline
Copertura dei test integrazione & \begin{math}[90\%]\end{math}& \begin{math}[100\%]\end{math}\\ \hline
Copertura dei test di unità & \begin{math}[80\%]\end{math}& \begin{math}[100\%]\end{math}\\ \hline
\end{tabular}
\end{center}
...
%\begin{itemize}
%\item \textbf{XXXAssegnazione dei ruoli} secondo la pianificazione specificata nel documento \textit{Piano-di-Progetto-2.0.pdf} redatto dal Responsabile di progetto;
%\item \textbf{XXXCorretta pianificazione di sviluppo} secondo quanto stilato sempre nel documento \textit{Piano-di-Progetto-2.0.pdf}. In particolare viene verificata la corretta divisione temporale delle diverse fasi di progetto (vedere sezione precedente) e la correttezza del preventivo in base al budget disponibile;
%\item \textbf{XXXDisponibilità delle risorse umane e tecnologiche} e dell'ambiente di lavoro;
%\item \textbf{XXXLettura e sottoscrizione delle Norme di Progetto}. Il responsabile deve accertarsi che ogni membro del gruppo abbia letto e compreso il documento \textit{Norme-di-progetto-2.0}. Il documento deve essere quindi preventivamente redatto.
%
%
%\end{itemize} 
% 
...
%Il codice prodotto deve seguire le regole definite nel documento \textit{Norme-di-progetto-2.0.pdf} e le direttive definite nel documento \textit{Definizione-di-dettaglio-1.0.pdf}.
...
\subsubsection{Requisiti funzionali}
	\begin{longtable}{p{0.10\columnwidth}p{0.10\columnwidth}p{0.50\columnwidth}p{0.15\textwidth}}
...
\begin{longtable}
{p{0.10\columnwidth}p{0.10\columnwidth}p{0.50\textwidth}p{0.15\textwidth}}
...
\begin{longtable}
{p{0.10\columnwidth} p{0.60\columnwidth} p{0.20\columnwidth}}
...
%TI5 & Viene verificato che View::Pages interagisca correttamente con View::Templates per la composizione delle pagine web da visualizzare & Superato\\\midrule
...
%TU23 & Verifica che venga visualizzato correttamente il form di autenticazione al sistema &Superato\\\midrule
%TU24 & Verifica che venga visualizzato correttamente il form di registrazione al sistema &Superato\\\midrule
%TU25 & Verifica che venga visualizzato correttamente il form di recupero password &Superato\\\midrule
%TU26 & Verifica che il form per la creazione di un questionario venga visualizzato correttamente &Superato\\\midrule
%TU27 & Verifica che il form per la modifica di una domanda venga visualizzato correttamente &Superato\\\midrule
%TU28 & Verifica che il form per la creazione di una domanda venga visualizzato correttamente &Superato\\\midrule
...
%TU30 & Verifica che vengano visualizzati i risultati del questionario compilato &Superato\\\midrule
%TU31 & Verifica che la visualizzazione di un questionario avvenga correttamente &Superato\\\midrule
...
\begin{center}
\begin{longtable}
{p{0.45\columnwidth} p{0.33\columnwidth}}
...
%ViewModel::Controller::NewQuizController::saveQuiz() &\\
\midrule
...
%ViewModel::Controller::QuizListController::orderBy()&\\
...
\midrule
%\textit{View::Pages::Page::show()} & TU26 \\
%\midrule
...
\begin{tabular}{{p{5cm} p{2.5cm} p{2.5cm} p{2.5cm}}}
\textbf{Metrica} & \textbf{Valore}&\textbf{Accettazione} & \textbf{Ottimale}\\ \hline
Schedule Variance & 10 & Superato & Superato\\
\midrule
Budget Variance & 390 & Superato & Superato\\
\end{tabular}
\end{center}
...
Copertura Test di Sistema & 96\% & Superato & Non superato \\ 
Copertura Test di Integrazione & 100\% & Superato & Superato \\
Copertura Test di Unità & 87\% & Superato & Non superato\\
\end{tabular}
\end{center}
\end{document}