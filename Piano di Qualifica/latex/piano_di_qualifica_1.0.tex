...
Il modello PDCA\addglos fornisce le linee guida per l'attività di controllo ed il miglioramento continuo dei processi: 
\begin{itemize}
...
\end{itemize}  
La descrizione delle attività di controllo e la loro pianificazione è descritta nel documento \textit{Piano\_di\_Progetto\_2.0.pdf}
...
\label{Appendice A}
 \textbf{DA RIVEDERE, AMPLIARE E CORREGGERE IMMAGINE MODELLO A V}\\
La suddivisione temporale delle diverse fasi di sviluppo segue il cosiddetto modello a V ed è descritta nel documento allegato \textit{Piano-di-Progetto-1.0.pdf}.
\begin{figure}[h!]
\centering
\includegraphics[scale=0.4]{../images/vmodel-final4.png}
