...
\begin{document}
	...
	\rigaregistro{2.4.1}{M.Crivellaro (Verificatore)}{3/7/2016}{Verifica finale}
...
\makebox[\linewidth]{%        to center the image
  \includegraphics[keepaspectratio=true,scale=0.6]{../images/ISO-9126-cut}}
\captionof{figure}{Riepilogo caratteristiche ISO/IEC 9126:2001}  
\end{minipage}\\
